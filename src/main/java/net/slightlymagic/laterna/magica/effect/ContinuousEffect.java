 ...
 * 
 * <p>
 * {@magic.ruleRef 610.1} A continuous effect modifies characteristics of objects, modifies control
 * of objects, or affects players or the rules of the game, for a fixed or indefinite period.
 * </p>
 * 
 * Such effects can either be <i>local</i>:
 * 
 * <p>
 * {@magic.ruleRef 610.2c} If a continuous effect generated by the resolution of a spell or ability
 * modifies the characteristics or changes the controller of any objects, the set of objects it affects is
 ...
 * 
 * <p>
 * {@magic.ruleRef 610.2c} ... A continuous effect generated by the resolution of a spell or
 * ability that doesn't modify the characteristics or change the controller of any objects modifies the rules of
 * the game, so it can affect objects that weren't affected when that continuous effect began.
 * </p>
 * 
 * <p>
 * {@magic.ruleRef 610.3a} A continuous effect generated by a static ability isn't "locked in"; it
...
public interface ContinuousEffect extends Timestamped {
    /**
     * The layers of applying continuous effects ({@magic.ruleRef 612 CR 612}). There are seven
