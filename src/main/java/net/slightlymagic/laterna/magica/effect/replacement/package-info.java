 ...
 * 
 * In a nutshell, all changes to the game are encapsulated in {@link net.slightlymagic.laterna.magica.edit.Edit Edit}s. Many changes,
 * like gaining or losing life, are replaceable. Thus, instead of executing such an edit directly, the
 * <i>replacement engine</i> handles this, and executes the Edit applicable after all replacement effects.
 * 
 ...
 * {@magic.ruleRef 616 CR 616}. The replacement engine looks for all replacement effects that apply to that event
 * and then, if there is more than one, lets the appropriate player choose one of them, as specified in CR 616.1
